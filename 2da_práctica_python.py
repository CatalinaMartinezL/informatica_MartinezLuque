# Ejercicio 1
# Definir un procedimiento que tome como parámetro una lista, verifique si tiene
# el elemento "control" y le agregue el string "revisado" y le quite el elemento "control".
...
def verificar_control(lista):
    if "control" in lista: 
        ...
        lista[indice] = "revisado" #Modifica el elemento el la posición en la que se encontraba control.
        

mi_lista = ['control',8,6,9]
verificar_control(mi_lista)

print(mi_lista)


# Ejercicio 2
# Definir un procedimiento que tome una lista como parámetro y elimine el primer
# elemento de la lista. Hacer las verificaciones que sean necesarias.
mi_lista = [1, 2, 3, 4, 5]
...
print(posicion_elemento([1,2,5,7,12], 5))


# Ejercicio 4
# Definir un procedimiento que tome como parámetros dos listas y un elemento,
#  en la que se debe eliminar el elemento de una lista y agregarlo a la otra.
#  Realizar dos versiones del ejercicio, usando un método distinto para eliminar 
# el elemento en cada versión. ¿Qué problema/s tiene este procedimiento?
...
lista1 = [3,7,2]
lista2 = [5,5,1]
eliminar_y_agregar(lista1,lista2,7)
print(lista1,lista2)
            

# Ejercicio 5
# Escribir una función que tome como parámetro una lista de enteros
# y devuelva una lista con valores booleanos que indique si cada elemento
#  es par o impar. Por ejemplo, para la lista [2, 45, 108, 12, 7], 
# la función debería retornar [True, False, True, True, False]. 

# ver como hacerlo

# Ejercicio 6
# Escribir una función que lea un string y devuelva un diccionario con 
# la cantidad de apariciones de cada carácter en la cadena (considerar 
# que las mayúsculas difieren de las minúsculas, por lo que, si el string
#  es "Agua", el carácter "A" tiene 1 aparición y el carácter "a" también tiene 1).

def cant_caracter(string):
    caracteres ={}
...
print(productoria([560,120,78,450]))

# Ejercicio 10
# Creá un programa para gestionar datos de los socios de un club, el cual permita:
# Cargar la información de los socios en un diccionario, al cual poder acceder por 
# número de socio. Los datos que se deben almacenar son: número, nombre y apellido,
#  fecha de ingreso (ddmmaaaa), cuota al dia (s/n). El programa debe iniciar con los
#  datos de los socios fundadores ya cargados, los cuales son:
